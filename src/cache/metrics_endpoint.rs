...
impl From<crate::cache::monitoring::HitRateReport> for HitRateJson {
    fn from(report: crate::cache::monitoring::HitRateReport) -> Self {
        Self {
            time_windows: TimeWindowsJson {
...
impl From<crate::cache::monitoring::RealTimeStatsReport> for StatsJson {
    fn from(stats: crate::cache::monitoring::RealTimeStatsReport) -> Self {
        Self {
