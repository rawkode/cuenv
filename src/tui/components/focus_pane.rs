use crate::tui::events::{LogEntry, LogStream, TaskInfo, TaskRegistry};
use ratatui::{
...
impl FocusPane {
    ...
    fn get_state_style(&self, state: &crate::tui::events::TaskState) -> Style {
        match state {
            crate::tui::events::TaskState::Queued => Style::default().fg(Color::DarkGray),
            crate::tui::events::TaskState::Running => Style::default().fg(Color::Yellow),
            crate::tui::events::TaskState::Completed => Style::default().fg(Color::Green),
            crate::tui::events::TaskState::Failed => Style::default().fg(Color::Red),
            crate::tui::events::TaskState::Cancelled => Style::default().fg(Color::Magenta),
        }
    }
