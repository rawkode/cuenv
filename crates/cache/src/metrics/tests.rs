//! Comprehensive tests for cache metrics functionality
//!
...
mod test {
    ...
    fn test_access_patterns() {
        ...
        metrics.record_access_pattern("pattern1");
        metrics.record_access_pattern("pattern2");
        metrics.record_access_pattern("pattern1"); // Duplicate
    ...
    fn test_reset() {
        ...
        metrics.update_size(100);
        metrics.update_compression_ratio(0.5);
        metrics.record_access_pattern("test_pattern");
    ...
    fn test_concurrent_operations() {
        ...
        assert_eq!(metrics.eviction_count(), expected_evictions as u64);
        assert_eq!(metrics.error_count(), expected_errors as u64);
    ...
    fn test_access_pattern_empty_string() {
        ...
        metrics.record_access_pattern("");
        metrics.record_access_pattern("normal_pattern");
        metrics.record_access_pattern("");
    ...
    proptest! {
        ...
        fn proptest_operations_count_correctly(
            ...
            prop_assert_eq!(metrics.eviction_count(), evictions);
            prop_assert_eq!(metrics.error_count(), errors);
        }
        ...
        fn proptest_access_patterns_counted_correctly(
            ...
            for pattern in &patterns {
                metrics.record_access_pattern(pattern);
        ...
        fn proptest_reset_clears_all_metrics(
            ...
            prop_assert!(metrics.eviction_count() > 0);
            prop_assert!(metrics.error_count() > 0);
            ...
            prop_assert_eq!(metrics.eviction_count(), 0);
            prop_assert_eq!(metrics.error_count(), 0);
