...
mod tests {
    ...
    // TODO: Fix this test once core::Cache implements traits::Cache
    // The test needs a type that implements traits::Cache but core::Cache doesn't
    // #[tokio::test]
    ...
    //     let endpoint = HealthEndpoint::new(cache, bind_addr, HealthEndpointConfig::default());
