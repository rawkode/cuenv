...
fn test_environment_variables() {
    ...
    assert_eq!(env_vars["CUENV_INPUT_PROJECTS_FRONTEND_DIST"], staged1.to_string_lossy());
    assert_eq!(env_vars["CUENV_INPUT_TOOLS_SCRIPTS_OUTPUT"], staged2.to_string_lossy());
}
